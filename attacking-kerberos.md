...
```sh
xfreerdp /dynamic-resolution +clipboard /cert:ignore /v:10.10.41.186 /u:Administrator /p:'P@$$W0rd'
```
...
![image](https://github.com/vivekprm/hackers-manual/assets/2403660/162ad241-edd3-4d33-b55f-f220cfde4205)

## Crack those Hashes w/ hashcat
1. Transfer the hash from the target machine over to your attacker machine and put the hash into a txt file
2. Insert 23$ after $krb5asrep$ so that the first line will be $krb5asrep$23$User.....Use the same wordlist shared above.
3. ```hashcat -m 18200 hash.txt Pass.txt``` - crack those hashes! Rubeus AS-REP Roasting uses hashcat mode 18200 

![image](https://github.com/vivekprm/hackers-manual/assets/2403660/b458ed53-a770-4762-85cb-81e88010a580)
...
![image](https://github.com/vivekprm/hackers-manual/assets/2403660/f0a940bc-2092-4707-98cb-25772f13e8f8)
...
![image](https://github.com/vivekprm/hackers-manual/assets/2403660/f54f868b-d8b4-4fdc-aef3-73baf2c1b5c1)
...
![image](https://github.com/vivekprm/hackers-manual/assets/2403660/83844820-639f-43ae-8d46-7495b006c402)
...
![image](https://github.com/vivekprm/hackers-manual/assets/2403660/d910728d-33d2-460c-9375-158ca86abb7d)
...
![image](https://github.com/vivekprm/hackers-manual/assets/2403660/c91cc7d5-9a1b-4776-a896-af003e0a7935)
...
![image](https://github.com/vivekprm/hackers-manual/assets/2403660/13c4b3e5-2d87-4128-bf43-f0d796daa721)

Note that this is only a POC to understand how to pass the ticket and gain domain admin the way that you approach passing the ticket may be different based on what 
kind of engagement you're in so do not take this as a definitive guide of how to run this attack.
...
![image](https://github.com/vivekprm/hackers-manual/assets/2403660/44f10eb5-e41b-4359-ae83-33c5748fb283)
...
![image](https://github.com/vivekprm/hackers-manual/assets/2403660/4afb7459-9ad9-4a3e-8bfd-cdd446f8b844)

## Use the Golden/Silver Ticket to access other machines
1. ```misc::cmd``` - this will open a new elevated command prompt with the given ticket in mimikatz.
![image](https://github.com/vivekprm/hackers-manual/assets/2403660/2584f7ba-6d06-4b9b-8b90-42bb2b6b6cb5)

2. Access machines that you want, what you can access will depend on the privileges of the user that you decided to take the ticket from however if you took the ticket from krbtgt you have access to the ENTIRE network hence the name golden ticket; however, silver tickets only have access to those that the user has access to if it is a domain admin it can almost access the entire network however it is slightly less elevated from a golden ticket.

![image](https://github.com/vivekprm/hackers-manual/assets/2403660/c945eba6-6668-4039-8c93-952c411100c7)
...
To get SQLService's NTLM hash:
```
mimikatz # lsadump::lsa /inject /name:SQLService
```
To get Administrator's NTLM hash:
```
